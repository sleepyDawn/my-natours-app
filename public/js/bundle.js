...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2xlZXB5ZGF3YW4iLCJhIjoiY2toYTdnN3dmMTFnMzJwbnE0Mm00ajJwbyJ9.bmrhKARgZ8gYsFMegiXf1g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/sleepydawan/ckha838ox0dj619tb99gt18y2',
    scroll: false // center: [-118, 34],
    // zoom: 6,
    // interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends map bound to include current locations
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            // console.log('successfully logged you out!!!clear');
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    var transporter, url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            transporter = _axios.default.create({
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51HmxQZEIBiWRqXwIzUAzbqkc3sKpwUA4YMEcXUlsyUWJ0gxWXZx7exwu0S4zk8fkVeMP0uQGJ3fOFcsEBfeVNUVy00eydHztKw'); // 1. Get checkout session from API
          ...
          case 4:
            ...
            console.log('checking session object: ', session); // 2. Use stripe object to create checkout form and charge credit card form
...
if (updateUserPasswordForm) {
  updateUserPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var passwordCurrent, passwordNew, passwordConfirmNew;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirmNew = document.getElementById('password-confirm').value;
              _context.next = 7;
